...
rem # - versao : zrfisaac.pt.batch.chocolatey.w4 - 0.0.1
...
set c_chocolatey=!c_chocolatey! googledrive
set c_chocolatey=!c_chocolatey! vscode
set c_chocolatey=!c_chocolatey! dbeaver
set c_chocolatey=!c_chocolatey! meld
set c_chocolatey=!c_chocolatey! openvpn-connect
set c_chocolatey=!c_chocolatey! insomnia-rest-api-client
set c_chocolatey=!c_chocolatey! frhed
set c_chocolatey=!c_chocolatey! tortoisegit
set c_chocolatey=!c_chocolatey! tortoisesvn
